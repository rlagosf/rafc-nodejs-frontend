...
export default function Nosotros() {
  ...
  return (
    <motion.section
      ...
      className="text-white font-sans px-6 pt-16 pb-12 bg-transparent flex flex-col items-center"
    >
      {/* Leyenda destacada */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl w-full items-stretch">
        {tarjetas.map((t, i) => {
          const tituloAlign = i === 0 ? 'text-left pr-6' : 'text-right pl-6';
          ...
          return (
            <motion.div
              ...
              className="relative p-4 md:p-6 rounded-2xl flex flex-col justify-between bg-transparent shadow-none border-none"
            >
              {/* Contenido */}
              <div>
                <h3 className={`text-2xl font-bold mb-4 uppercase tracking-wide ${tituloAlign}`}>
                  {t.titulo}
                </h3>
