    ...
    <div className="min-h-screen font-realacademy text-[#1a1a1a] bg-[#e9eaec]">
      ...
      <div aria-hidden className="pointer-events-none fixed inset-0 -z-10">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(232,45,137,0.30), transparent 60%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(0,0,0,0.08), transparent 60%)",
          }}
        />
        <div
          ...
          <div className="rounded-[28px] border border-black/10 bg-[#f2f2f3] shadow-[0_20px_70px_rgba(0,0,0,0.10)] overflow-hidden">
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="hidden sm:flex items-center gap-3">
                  <div className="text-right leading-tight">
                    <p className="text-xs font-black tracking-[0.35em] uppercase text-[#e82d89]">
                      Real Academy FC
                    </p>
            ...
            <div className="px-6 sm:px-10 py-10">
              ...
              <div className="text-center mb-8">
                <h1 className="text-4xl sm:text-5xl font-extrabold tracking-widest uppercase text-[#e82d89]">
                  Portal Apoderados
                </h1>
            ...
            {/* Footer Tip (centrado y dentro de la tarjeta) */}
