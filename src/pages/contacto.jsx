...
export default function Contacto() {
  const numeroWhatsapp = "56967438184";
  const link = useMemo(() => {
    const mensaje =
  ...
  return (
    <section
      id="contacto"
      className="min-h-[80vh] text-white flex items-center justify-center font-sans bg-transparent"
    >
      <div className="w-full max-w-6xl px-6 py-16 mx-auto flex flex-col items-center text-center bg-transparent">
        {/* --- Imagen principal (en reemplazo del título) con animación por scroll --- */}
        <motion.div
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
        ...
        {/* --- Letreros inclinados estilo “Nosotros” con animación por scroll --- */}
        <div className="relative mb-10 select-none">
          ...
          >
            <span className="block text-2xl md:text-3xl font-extrabold uppercase tracking-wider px-6 py-3 rounded leading-tight bg-transparent border border-transparent backdrop-blur-sm shadow-none">
          ...
          >
            <span className="block text-xl md:text-2xl font-black uppercase tracking-widest px-6 py-3 rounded bg-transparent border border-transparent shadow-none">
              ¡Reserva tu cupo!
            </span>
          </motion.div>
        </div>

        {/* --- Botón oficial de WhatsApp (aparece al hacer scroll) --- */}
        <motion.a
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
        ...
        {/* --- Sección Equipamiento RAFC (las tarjetas ya tenían whileInView) --- */}
        <div className="w-full mt-16">
          <div className="mb-6">
            <div className="inline-block -rotate-1">
              <span className="inline-block px-6 py-3 rounded bg-transparent border border-transparent backdrop-blur-sm shadow-none text-lg md:text-xl font-bold uppercase tracking-wide">
                Al ser parte de{" "}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.article
                ...
                className="rounded-xl bg-transparent border border-transparent backdrop-blur-sm shadow-none flex flex-col items-center text-center p-4"
              >
                <img
                  src={item.src}
                  alt={item.alt}
        ...
        >
          ...
          <FileText
            size={100}
            className="text-[#e82d89] transition duration-300 hover:scale-105"
          />
        </a>
      </div>
    </section>
